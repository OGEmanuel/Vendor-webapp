...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    authControllerSigninWIthOtp: async (
      signinOTPDTO: SigninOTPDTO,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async authControllerSignin(
      signinDTO: SigninDTO,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SigninResponsePayload>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authControllerSignin']?.[localVarOperationServerIndex]?.url;
     ...
     * @throws {RequiredError}
     */
    async authControllerSigninWIthOtp(
      signinOTPDTO: SigninOTPDTO,
      options?: RawAxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SigninWithOTPResponsePayload>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerSigninWIthOtp(
        signinOTPDTO,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authControllerSigninWIthOtp']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async authControllerSignup(
      createAccountDTO: CreateAccountDTO,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignupResponsePayload>> {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authControllerSignup']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const AuthApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    authControllerSigninWIthOtp(
      signinOTPDTO: SigninOTPDTO,
      options?: any
    ): AxiosPromise<SigninWithOTPResponsePayload> {
      return localVarFp
        .authControllerSigninWIthOtp(signinOTPDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    authControllerSignup(
      createAccountDTO: CreateAccountDTO,
      options?: any
    ): AxiosPromise<SignupResponsePayload> {
      return localVarFp
        .authControllerSignup(createAccountDTO, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const PasswordApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    authControllerResetPasswordOTPAuthorization: async (
      resetPasswordOTPAuthorizationDTO: ResetPasswordOTPAuthorizationDTO,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'resetPasswordOTPAuthorizationDTO' is not null or undefined
      assertParamExists(
        'authControllerResetPasswordOTPAuthorization',
        'resetPasswordOTPAuthorizationDTO',
        resetPasswordOTPAuthorizationDTO
      );
...
export const PasswordApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async authControllerForgotPassword(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordApi.authControllerForgotPassword']?.[
     ...
     * @throws {RequiredError}
     */
    async authControllerForgotPasswordOTPReset(
      forgotPasswordOTPDTO: ForgotPasswordOTPDTO,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerForgotPasswordOTPReset(
          forgotPasswordOTPDTO,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordApi.authControllerForgotPasswordOTPReset']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async authControllerResetPassword(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordApi.authControllerResetPassword']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async authControllerResetPasswordOTPAuthorization(
      resetPasswordOTPAuthorizationDTO: ResetPasswordOTPAuthorizationDTO,
      options?: RawAxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ResetPasswordOTPAuthorizationResPayload>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerResetPasswordOTPAuthorization(
          resetPasswordOTPAuthorizationDTO,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['PasswordApi.authControllerResetPasswordOTPAuthorization']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const PasswordApiFactory = function (
  ...
  return {
    ...
    authControllerForgotPasswordOTPReset(
      ...
      return localVarFp
        .authControllerForgotPasswordOTPReset(forgotPasswordOTPDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    authControllerResetPasswordOTPAuthorization(
      ...
      return localVarFp
        .authControllerResetPasswordOTPAuthorization(resetPasswordOTPAuthorizationDTO, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class PasswordApi extends BaseAPI {
   ...
   * @memberof PasswordApi
   */
  public authControllerForgotPasswordOTPReset(
    forgotPasswordOTPDTO: ForgotPasswordOTPDTO,
    options?: RawAxiosRequestConfig
  ) {
    return PasswordApiFp(this.configuration)
   ...
   * @memberof PasswordApi
   */
  public authControllerResetPasswordOTPAuthorization(
    resetPasswordOTPAuthorizationDTO: ResetPasswordOTPAuthorizationDTO,
    options?: RawAxiosRequestConfig
  ) {
    return PasswordApiFp(this.configuration)
...
export const VerificationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    authControllerSendEmailVerification: async (
      sendEmailVerificationCredDTO: SendEmailVerificationCredDTO,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'sendEmailVerificationCredDTO' is not null or undefined
      assertParamExists(
        'authControllerSendEmailVerification',
        'sendEmailVerificationCredDTO',
        sendEmailVerificationCredDTO
      );
...
export const VerificationsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async authControllerCompleteEmailVerification(
      verificationEmailDTO: VerificationEmailDTO,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerCompleteEmailVerification(
          verificationEmailDTO,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['VerificationsApi.authControllerCompleteEmailVerification']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async authControllerSendEmailVerification(
      sendEmailVerificationCredDTO: SendEmailVerificationCredDTO,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerSendEmailVerification(
        sendEmailVerificationCredDTO,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['VerificationsApi.authControllerSendEmailVerification']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const VerificationsApiFactory = function (
  ...
  return {
    ...
    authControllerCompleteEmailVerification(
      ...
      return localVarFp
        .authControllerCompleteEmailVerification(verificationEmailDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    authControllerSendEmailVerification(
      ...
      return localVarFp
        .authControllerSendEmailVerification(sendEmailVerificationCredDTO, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class VerificationsApi extends BaseAPI {
   ...
   */
  public authControllerCompleteEmailVerification(
    verificationEmailDTO: VerificationEmailDTO,
    options?: RawAxiosRequestConfig
  ) {
   ...
   * @memberof VerificationsApi
   */
  public authControllerSendEmailVerification(
    sendEmailVerificationCredDTO: SendEmailVerificationCredDTO,
    options?: RawAxiosRequestConfig
  ) {
    return VerificationsApiFp(this.configuration)
